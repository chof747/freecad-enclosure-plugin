...
**Tests**: Include test tasks when requested by the feature specification.
Always include lint and integration smoke tasks required by the constitution.
...
- [ ] T002 Initialize Python project and dependencies with `uv`
- [ ] T003 [P] Configure `flake8` and formatting tools
...
- [ ] T010 Add FreeCAD integration smoke-run path for earliest feature slice
...
- [ ] TXXX Run `uv run flake8` and fix all violations
- [ ] TXXX Validate FreeCAD integration smoke run end-to-end
